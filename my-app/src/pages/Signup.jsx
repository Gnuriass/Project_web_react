...
function Signup() {
  ...
  const [age, setAge] = useState(""); // ✅ เพิ่ม state อายุ
  ...
  const handleSignup = async () => {
    if (username && email && password && gender && province && age) {
      try {
        const newUser = { username, email, password, gender, province, age }; // ✅ ส่ง age ไปด้วย
